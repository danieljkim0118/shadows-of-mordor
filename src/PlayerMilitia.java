...
public abstract class PlayerMilitia implements BattleUnit, Comparable<BattleUnit> {
	...
	public PlayerMilitia(boolean v1, boolean v2, int v3, int v4, int v5, int v6, double v7, int v8) {
		side = v1;
		battleState = v2;
		xPos = v3;
		yPos = v4;
